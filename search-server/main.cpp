...
public:
    ...
    explicit SearchServer(const StringContainer& stop_words)
        ...
        for (string wordFromStops : stop_words_) {
...
private:
    ...
    //No double minus before a word and no minus without words
    [[nodiscard]] bool IsntRightWord(const string& text) const {
